...
def load_model(
    ...
    params = {k: v for k, v in params.items() if k in ModelArgs.__init__.__code__.co_varnames}
    ...
    # tokenizer = Tokenizer(model_path=ckpt_dir + "/tokenizer.model")

    print(model_args.vocab_size, tokenizer.vocab_size)
