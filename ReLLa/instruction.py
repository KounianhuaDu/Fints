...
```"""
    ...
    #     inp = f"Your Memory of This User:\n\n{his}"
    #     product_info = prompt["output"]["product_info"]
    #     inp += f"You need to call the tool correctly to get the target product.\nHere is the product information: {pretty_product(product_info)}"
    #     if prompt['type'] == 'search':
    #         inp += "\nYou have access to the following tool:"
    #         inp += json.dumps(functions_info['search_product_by_query'])
    #     elif prompt['type'] == 'recommend':
    #         inp += "\nYou have access to the following tool:"
    #         inp += json.dumps(functions_info['get_recommendations_by_history'])
